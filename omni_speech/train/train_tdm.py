...
def train(attn_implementation=None):
    ...
    if model_args.speech_encoder is not None:
        if "llama_3" in model_args.version or model_args.version == 'hcx':
    ...
    elif model_args.version == 'hcx':
        tokenizer.pad_token = '<|endoftext|>'
        tokenizer.pad_token_id = tokenizer.convert_tokens_to_ids("<|endoftext|>")
        conversation_lib.default_conversation = conversation_lib.conv_templates["hcx"]
